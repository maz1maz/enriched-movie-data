...
- ✅ **ستون‌های سریال** — برای سریال‌ها تعداد فصل‌ها، مجموع قسمت‌ها و تعداد قسمت‌های هر فصل هم خروجی گرفته می‌شود
...
- ✅ **Skip هوشمند** — فیلم‌های کامل رد می‌شن؛ سریال‌ها فقط وقتی رد می‌شن که اطلاعات فصل/قسمت هم پر شده باشه
- ✅ **حالت Quiet** — `--quiet` برای کاهش لاگ
- ✅ **تعداد فصل و قسمت سریال‌ها** — ستون‌های `Seasons Available`, `Total Episodes`, `Episodes by Season` برای سریال‌ها
...
- **اطلاعات فصل/قسمت**: از endpointهای `/shows/{id}/episodes` و `/shows/{id}/seasons`
- **Limit**: نامحدود
